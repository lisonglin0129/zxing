...
import com.camera.View.ViewfinderView;
import com.camera.camera.CameraManager;
import com.camera.common.AmbientLightManager;
import com.camera.common.BeepManager;
import com.camera.common.BitmapUtils;
import com.camera.common.InactivityTimer;
import com.camera.common.IntentSource;
import com.camera.decode.BitmapDecoder;
import com.camera.decode.CaptureActivityHandler;
import com.camera.decode.FinishListener;
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK: {
                if ((source == IntentSource.NONE) && lastResult != null) { // 重新进行扫描
                    ...
                    data.putExtra(SCAN_QRCODE_RESULT, "");
                    data.putExtra(SCAN_QRCODE_BITMAP, "");
                    setResult(0, data);
                }
                break;
            }
